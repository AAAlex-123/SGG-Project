...
public:
	...
	const static int PLAYER = 0, SIMPLE_ENEMY = 1, SIMPLE_ENEMY2 = 7, ROTATING_ENEMYD = 2, ROTATING_ENEMYC = 6, ROTATING_ENEMYCA = 8, ACCELERATING_ENEMY = 3, TANK_ENEMY = 4, HOMING_ENEMY = 5;
